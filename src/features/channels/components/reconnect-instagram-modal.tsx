...
export function ReconnectInstagramModal({
  ...
  return (
    <>
      ...
      >
        <DialogHeader
          title={m.channels_instagram_reconnect_title()}
          onOpenChange={handleOpenChange}
        />
        {isOpen && (
      ...
      <AlertDialog
        ...
        title={m.channels_instagram_reconnect_discard_title()}
        description={m.channels_instagram_reconnect_discard_description()}
