...
set local request.jwt.claims =
  '{"sub":"00000000-0000-4000-8000-0000000000f1","role":"authenticated"}';
insert into public.workspaces (name, is_main) values ('CRED WS A', false);
insert into public.workspaces (name, is_main) values ('CRED WS B', false);
reset role;
